...
public class WebElements extends TestBase1 {
 public WebDriverWait wait=new WebDriverWait(driver,180);
	...
	@FindBy(xpath="//select[@id='column-selector']")
	WebElement columnDropdown;
	@FindBy(xpath="//select[@id='comparator']")
	WebElement comparatorDropdown;
	@FindBy(xpath="//input[@id='first-control']")
	WebElement valueTxtbox;
	@FindBy(xpath="//button[@id='add-filter']")
